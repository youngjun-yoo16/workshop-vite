...
export default function SaumyaPage() {
    ...
    <div className={`h-screen w-screen bg-black ${showOutline ? 'outline' : ''}`}>
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../saumya.png" // Placeholder image
            alt="Profile Picture"
          ...
          {/* Member Info */}
          <div className="text-center items-center text-white mt-8">
            <h2 className="text-4xl  font-bold">Saumya Gupta</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer science student at Purdue University, from Monroe Township NJ.
              This is my first year in Hack the Future and I am super excietd!
            </p>
          </div>
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a href="https://www.linkedin.com/in/saumya-gupta5/" target="_blank" rel="noreferrer">
