    ...
    >
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../junpic.jpg" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Youngjun Yoo</h2>
            <h3 className="text-xl mt-2">Team Lead</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer Science student at Purdue University, from Seoul, South
              Korea. 2nd year in Hack the Future, previously a member of YWCA
              Billing team.
            </p>
          </div>
          <Link
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a
              href="https://www.linkedin.com/in/youngjun-yoo/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/y_jun.y/"
              target="_blank"
              rel="noreferrer"
            >
